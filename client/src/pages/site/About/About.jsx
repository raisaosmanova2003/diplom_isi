  ...
  return (
    <>
     <Helmet>
      ...
      <section className="about_sec text-center">
     ...
     data-aos-easing="ease-in-sine">Our History</h3>
                ...
                <div className="history_left_title">
                  <p data-aos="zoom-out-right">
                    ...
                    my gone to this so. Discovered interested <br /> prosperous
                    the our affronting insipidity day. Missed lovers way one
                    vanity <br /> wishes nay but. Use shy seemed within twenty
                    wished old few regret <br /> passed. Absolute one hastened
                    mrs any sensible. <br /> <br /> Two assure edward whence the
                    was. Who worthy yet ten boy denote <br /> wonder. Weeks
                    views her sight old tears sorry. Additions can suspected{" "}
                    <br /> its concealed put furnished. Met the why particular
                    devonshire decisively <br /> considered partiality.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img
                        ...
                        src="https://demo2.tokomoo.com/livre-el/wp-content/uploads/sites/20/2016/11/Profesi_014.jpg"
                        alt="First slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        class="d-block w-100 h-25"
                        src="https://demo2.tokomoo.com/livre-el/wp-content/uploads/sites/20/2016/11/Profesi_050.jpg"
                        alt="Second slide"
                      />
                    </div>
                  </div>
